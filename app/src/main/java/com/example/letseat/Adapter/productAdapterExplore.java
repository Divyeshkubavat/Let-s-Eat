...
public class productAdapterExplore extends RecyclerView.Adapter<productAdapterExplore.MyViewHolder> {
    ArrayList<Product> list;
    Context context;
    RetrofitServices retrofitServices;
    UserApi userApi;
    public productAdapterExplore(ArrayList<Product> list, Context context) {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new productAdapterExplore.MyViewHolder(LayoutInflater.from(context).inflate(R.layout.activity_user_product_view_design,parent,false));
    }
    @Override
